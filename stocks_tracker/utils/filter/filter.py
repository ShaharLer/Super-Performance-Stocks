    ...
    def calculate_ps_metrics(stock):
        ...
        if stock.target_avg_sales:
            ...
            try:
                ...
                profit_margins = (yahoo_stock.get_key_statistics_data()[stock.symbol]["profitMargins"])
                ...
                ev_to_profit_ratio = round(stock.ev_to_sell_ratio / profit_margins,2)
                ...
                print("growth adujsted ev / sells: " +str(round(stock.ev_to_sell_ratio / float(stock.target_sales_growth[:-1]),2)))
