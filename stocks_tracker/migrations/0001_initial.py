# Generated by Django 3.1.2 on 2021-01-24 10:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_income_growth', models.BooleanField(default=True)),
                ('eps_growth', models.BooleanField(default=True)),
                ('sales_growth', models.BooleanField(default=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='QuarterlyStat',
            fields=[
                ('stockstat_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='stocks_tracker.stockstat')),
            ],
            bases=('stocks_tracker.stockstat',),
        ),
        migrations.CreateModel(
            name='YearlyStat',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quarterly_stats', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='stocks_tracker.quarterlystat')),
                ('yearly_stats', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='stocks_tracker.yearlystat')),
            ],
            options={
                'ordering': ['symbol'],
            },
