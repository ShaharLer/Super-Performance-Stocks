# Generated by Django 3.1.2 on 2021-03-21 18:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ev_to_sell_ratio', models.FloatField(blank=True, default=None, null=True)),
                ('ps_to_growth_ratio', models.FloatField(blank=True, default=None, null=True)),
                ('gross_margins', models.FloatField(blank=True, default=None, null=True)),
            ],
            options={
                'ordering': ['symbol'],
            },
